	...
	return &CFLIPConfig{
		...
		Models: map[string]ModelConfig{
			...
			"claude-sonnet-4": {
				...
				Provider:      "anthropic",
				Category:      "sonnet",
				Description:   "Advanced model for most tasks",
				MaxTokens:     200000,
				ContextWindow: 200000,
			...
			"glm-4.6-air": {
				...
				Provider:      "glm",
				Category:      "haiku",
				Description:   "Lightweight model with fast responses (2025)",
				MaxTokens:     8192,
				ContextWindow: 200000,
				Capabilities:  []string{"text", "code", "multimodal"},
			},
			"glm-4.6": {
				ID:            "glm-4.6",
				Name:          "GLM-4.6",
				Provider:      "glm",
				Category:      "sonnet",
				Description:   "Flagship model with superior agentic capabilities (2025)",
				MaxTokens:     8192,
				ContextWindow: 200000,
				Capabilities:  []string{"text", "code", "reasoning", "multimodal", "tool-calling"},
			},
		...
		Providers: map[string]ProviderInfo{
			"anthropic": {
				...
				Models:  []string{"claude-3-5-haiku-20241022", "claude-sonnet-4", "claude-opus-4"},
			...
			"glm": {
				...
				Models:  []string{"glm-4.6-air", "glm-4.6"},
				EnvVars: map[string]string{"API_TIMEOUT_MS": "3000000"},
