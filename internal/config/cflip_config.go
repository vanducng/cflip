	...
	return &CFLIPConfig{
		...
		Models: map[string]ModelConfig{
			...
			"glm-4.5-air": {
				...
				Provider:      "glm",
				Category:      "haiku",
				Description:   "Fast and efficient model with enhanced reasoning (2025)",
				MaxTokens:     8192,
			...
			"glm-4.6": {
				...
				Provider:      "glm",
				Category:      "sonnet",
				Description:   "Advanced model with superior reasoning capabilities (beta)",
				MaxTokens:     8192,
				ContextWindow: 128000,
				Capabilities:  []string{"text", "code", "reasoning", "multimodal"},
			},
